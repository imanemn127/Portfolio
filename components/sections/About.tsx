...
function useFacts() {
  return [
    ...
    { label: "Projects",    display: "8+",   numeric: 8,    decimals: 0, suffix: "+", context: "ML · DL · CV · RAG · RL · edge AI" },
    { label: "Languages",   display: "4",    numeric: 4,    decimals: 0, suffix: "",  context: "French, Arabic (C2) · English (C1) · German (A1)" },
...
type Fact = { label: string; display: string; numeric: number; decimals: number; suffix: string; context: string }
function CountStat({ fact, inView }: { fact: Fact; inView: boolean }) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-16 lg:gap-24 mb-20">
          ...
          <div>
            ...
            <AnimatedText
              text="Currently at Inria researching AI-driven field boundary detection from satellite imagery. Previously: YOLOv8 olive tree trunk detection at Pellenc."
